...
public class Boards {
    ...
    public static final class CASE_2 {
        public static final String BOARD_STR = """
                                               5 3
                                               YYYY YYYY YYYY YYYY YGRG
                                               RRCR RRRR RRRR RRRR RRYY
        ...
        public static final Tile[][] TARGET_BOARD = {
            ...
            new Tile[]{
                new Tile(RCCY), new Tile(CMMC), new Tile(MCCM), new Tile(CCCC), new Tile(CGCG)
            }
        };
    }
    ...
    public static final Colours RCCY = new Colours(Colour.RED, Colour.CYAN, Colour.CYAN, Colour.YELLOW);
